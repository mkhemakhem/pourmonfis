...
def affiche():
    ...
    for ligne in range(6):
        ...
        print(str(grille_affiche[ligne]).replace(",", "").replace(
            "[", "").replace("]", "").replace("'", ""))
...
def vertp(grille, joueur, ligne, colonne, position):
    ...
    if position == 1 and ligne < 3:
        retour = grille[ligne+1][colonne] == joueur and grille[ligne +
                                                               2][colonne] == joueur and grille[ligne+3][colonne] == joueur
    if position == 2 and ligne < 4 and ligne > 0:
        retour = grille[ligne-1][colonne] == joueur and grille[ligne +
                                                               1][colonne] == joueur and grille[ligne+2][colonne] == joueur
    if position == 3 and ligne < 5 and ligne > 1:
        retour = grille[ligne-2][colonne] == joueur and grille[ligne -
                                                               1][colonne] == joueur and grille[ligne+1][colonne] == joueur
    if position == 4 and ligne > 2:
        retour = grille[ligne-3][colonne] == joueur and grille[ligne -
                                                               2][colonne] == joueur and grille[ligne-1][colonne] == joueur
...
def diagp(grille, joueur, ligne, colonne, position):
    ...
    retour2 = bool(False)
    try:
        retour1 = grille[ligne][colonne] == joueur and grille[ligne+1][colonne +
                                                                       1] == joueur and grille[ligne+2][colonne+2] == joueur and grille[ligne+3][colonne+3] == joueur
    except:
        retour1 = bool(False)
    try:
        if position == 1 and ligne < 3 and colonne < 4:
            retour1 = grille[ligne+1][colonne+1] == joueur and grille[ligne +
                                                               2][colonne+2] == joueur and grille[ligne+3][colonne+3] == joueur
    except:
        retour1 = bool(False)
    try:
        if position == 1 and ligne < 3 and colonne > 2:
            retour2 = grille[ligne+1][colonne-1] == joueur and grille[ligne +
                                                                  2][colonne-2] == joueur and grille[ligne+3][colonne-3] == joueur
    except:
        retour2 = bool(False)
    try:
    ...
    try:
        if position == 3 and ligne < 5 and ligne > 1 and colonne > 1 and colonne < 6:
           retour1 = grille[ligne-2][colonne-2] == joueur and grille[ligne -
                                                                  1][colonne-1] == joueur and grille[ligne+1][colonne+1] == joueur
    except:
        retour1 = bool(False)
    try:
        if position == 3 and ligne < 5 and ligne > 1 and colonne > 0 and colonne < 5:
            retour2 = grille[ligne-2][colonne+2] == joueur and grille[ligne -
                                                                  1][colonne+1] == joueur and grille[ligne+1][colonne-1] == joueur
    except:
        retour2 = bool(False)
    ...
    try:
        if position == 4 and ligne > 2 and colonne > 2:
            retour1 = grille[ligne-3][colonne-3] == joueur and grille[ligne -
	                                                                  2][colonne-2] == joueur and grille[ligne-1][colonne-1] == joueur
    except:
        retour1 = bool(False)
    try:
        if position == 4 and ligne > 2 and colonne < 4:
            retour2 = grille[ligne-3][colonne+3] == joueur and grille[ligne -
                                                                  2][colonne+2] == joueur and grille[ligne-1][colonne+1] == joueur
